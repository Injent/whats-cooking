...
execute as @e[type=block_display,tag=i_mixer_input,sort=nearest,limit=1] positioned as @s align xyz positioned ~0.5 ~ ~0.5 run function injent:cook/process/shared/set_item_from
